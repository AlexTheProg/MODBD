...
DROP SERVER Europe CASCADE;
DROP SERVER North_America CASCADE;
DROP SERVER Asia CASCADE;
DROP SERVER Oceania CASCADE;
...
-- GRANT SELECT ON TABLE public.workspace_oce TO postgres;
...
INSERT INTO public.new_workspace(
    workspace_id, workspace_name, description, region_id)
VALUES (gen_random_uuid(), 'NA_Workspace', 'NA_Description',10);

INSERT INTO public.new_workspace(
    workspace_id, workspace_name, description, region_id)
VALUES (gen_random_uuid(), 'AS_Workspace', 'AS_Description3', 20);

INSERT INTO public.new_workspace(
    workspace_id, workspace_name, description, region_id)
VALUES (gen_random_uuid(), 'EU_Workspace', 'Eu_Description', 30);

-- DELETE FROM new_workspace;


--Fragmentare derivata
...
select * from "user_eu";
INSERT INTO "user" (
    user_id, username, password, first_name, last_name,created_by, created_date, last_modified_by, last_modified_date, email, workspace_id  )
VALUES (3, 'username3', 'password', 'first_name', 'last_name','created_by', '2016-06-22 19:10:25-07', 'last_modified_by', '2016-06-22 19:10:25-07', 'email3', '69ff6e53-747c-4fbb-b097-2be11600e376');
...
INSERT INTO "users" (
    user_id, username, password, first_name, last_name,created_by, created_date, last_modified_by, last_modified_date, email, workspace_id  )
VALUES (5, 'EU USER2', 'password', 'first_name', 'last_name','created_by', '2016-06-22 19:10:25-07', 'last_modified_by', '2016-06-22 19:10:25-07', 'email5', 'edb32df8-a961-4569-8bff-b5711886ce9a');
